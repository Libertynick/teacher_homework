...
from src.backend.clients.http_client.utils import attach_request_data


class HTTPClient:
    def __init__(self, host: str, default_headers: Optional[dict] = None) -> None:
        self._host = host
        self._default_headers = default_headers

    def get(self, route: str, headers: Optional[dict] = None, params: Optional[dict] = None, **kwargs) -> requests.Response:
        return self._request(method=HTTPMethod.GET, route=route, headers=headers, params=params, **kwargs)
